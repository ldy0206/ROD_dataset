...
def main() -> None:
    ...
    ax_a.set_title(f'Cross-validation ROC curve')
    ...
    ax_b.set_title('Performance on the temporally independent test set')
    ...
    ax_c1.set_title(f'ROC on Test Set')
    ...
    ax_c2.set_title(f'PR on Test Set')
